...
# Data generated by the Qwen notebook goes here
...
export EXP_NAME="Qwen2.5-VL-7B-Instruct-Lego-3" # TODO: change this to your own experiment name
TASK_TYPE="rec"
